                ...
                <div class="w-full mt-4 rounded-lg lg:block hidden bg-[#212327]">
                    ...
                    <div class="h-[80px] hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold mb-6 text-[17px]">Wimbledon Open 2023</div>
                            </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text-[14px] text-gray-400">Trending in US</div>
                                <div class="w-full text-white font-extrabold text-[17px]">Virtual Reality</div>
                                <div class="text-[14px] text-gray-400">7,000 Tweets</div>
                            </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                <div class="text-[14px] text-gray-400">Crypto Trending</div>
                                <div class="w-full text-white font-extrabold text-[17px]">BitCoin</div>
                                <div class="text-[14px] text-gray-400">9,000 Tweets</div>
                            </div>
                            <DotsHorizontal fillColor="5E5C5C"/>
                        </div>
                    </div>
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[17px]">NBA</div>
                                <div class="text-[14px] text-gray-400">8,000 Tweets</div>
                            </div>
                            <DotsHorizontal fillColor="5E5C5C"/>
                        </div>
                    </div>
    ...
    <div id="OverlaySection" v-if="createTweet" class="fixed top-0 left-0 w-full h-screen bg-black md:bg-gray-400 md:bg-opacity-30 md:p-3">
        <div class="md:max-w-2xl md:mx-auto md:mt-10 md:rounded-xl bg-black">
            <div 
                ...
                "
            >
                <div @click="closeMessageBox()" class="hover:bg-gray-800 inline-block rounded-full cursor-pointer">
            ...
            <div class="w-full flex">
                ...
                <div class="w-[calc(100%-100px)]">
                    ...
                    <div class="flex items-center py-2 text-[#1C9CEF] font-extrabold">
